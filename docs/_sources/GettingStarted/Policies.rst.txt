...
**Removal:** 
   ...
   HPC cluster accounts will be audited each month. UW-Madison users who have not used the cluster in more than three months will be contacted to verify that they still need access. PIs of research groups are responsible for contacting the HPC staff when a user has left their group.

**Locking:** 
  
    Accounts may be locked without warning for users misusing the cluster. If your account is locked, you will receive an e-mail from the HPC staff with steps to unlock your account.  
...
**Security:**
    ...
    HPC users must comply with all campus IT and Cybersecurity policies. Please review these policies `here. <https://it.wisc.edu/it-community/governance/information-technology-committee-itc/it-policies>`_
